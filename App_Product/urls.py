...
urlpatterns = [
    ...
    path('htmx/add-simple/<int:product_id>/', views.add_to_cart, name='add_to_cart_simple'),
    path('htmx/add-detail/<int:product_id>/', views.add_to_cart, name='add_to_cart_detail'),
